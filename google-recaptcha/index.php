...
#下面是在https://www.google.com/recaptcha/admin获取的密匙
$siteKey = '';
$secret = '';
#这里查看语言https://developers.google.com/recaptcha/docs/language
$lang = 'zh-CN';
//获得流量信息
                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-body">
                            ...
                            <?php  if($oo->is_able_to_check_in())  { ?>
                              <form action="_checkin.php" method="post">
                              ...
                              <p id="checkin-btn"> <input type="submit" id="checkin" class="btn btn-success  btn-flat" value="签到"></p>
                              </form>
                            <?php  }else{ ?>
